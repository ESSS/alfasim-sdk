...
PIG_DESCRIPTION = case_description.PigEquipmentDescription(
    ...
    wall_friction=Scalar(70, "Ns/m"),
    wall_friction_curve=Curve(Array([70.0], "Ns/m"), Array([0], "s")),
    linear_friction_input_type=constants.MultiInputType.Curve,
    linear_friction=Scalar(80, "Ns/m"),
    linear_friction_curve=Curve(Array([80.0], "Ns/m"), Array([0], "s")),
    quadratic_friction_input_type=constants.MultiInputType.Curve,
    quadratic_friction=Scalar(90, "Ns/m"),
    quadratic_friction_curve=Curve(Array([90.0], "Ns/m"), Array([0], "s")),
