...
inline int alfasim_sdk_open(ALFAsimSDK_API* api)
{
    ...
    api->get_ucm_gasliq_surface_tension_input_variable = (get_ucm_input_variable_func)GetProcAddress(api->handle, "get_ucm_gasliq_surface_tension_input_variable");
    api->get_ucm_liqliq_shear_force_per_volume_input_variable = (get_ucm_input_variable_func)GetProcAddress(api->handle, "get_ucm_liqliq_shear_force_per_volume_input_variable");
