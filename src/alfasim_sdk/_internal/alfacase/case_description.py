...
class _MassSourceCommon:
    ...
    # fmt: on
    # [[[end]]] (sum: cHrgHy1ZUo) (sum: cHrgHy1ZUo) (sum: Nu7J18/uyl)
    ...
    # fmt: on
    # [[[end]]] (sum: ryPvlsBfAA) (sum: ryPvlsBfAA) (sum: LHETA/Ml6x)
    ...
    # fmt: on
    # [[[end]]] (sum: Th/dj6mqXP) (sum: Th/dj6mqXP)  (sum: TdUaJF6JS+)
    ...
    # fmt: on
    # [[[end]]] (sum: bdPklFPWoX) (sum: bdPklFPWoX) (sum: z0hwjEu4RX)
    ...
    # fmt: on
    # [[[end]]] (sum: U2CeC0W/Rq) (sum: U2CeC0W/Rq) (sum: 5Lrwey+Qot)
    ...
    # fmt: on
    # [[[end]]] (sum: Q3qUPbL4l2) (sum: Q3qUPbL4l2) (sum: SvK32WGNil)
...
class _PressureSourceCommon:
    ...
    # fmt: on
    # [[[end]]] (sum: NgSGOwktFe) (sum: NgSGOwktFe) (sum: /grsrjTChp)
    ...
    # fmt: on
    # [[[end]]] (sum: xh4XHDXoAW) (sum: xh4XHDXoAW)  (sum: 3ryMqAbjl3)
    ...
    # fmt: on
    # [[[end]]] (sum: YoWQpGvjkl) (sum: YoWQpGvjkl) (sum: rikXFMJhOC)
    ...
    # fmt: on
    # [[[end]]] (sum: 7z7g1W75CY) (sum: 7z7g1W75CY) (sum: yzsWkpscA9)
...
class SpeedCurveDescription:
    ...
    time: Array = attrib_array(Array([0], "s"))
    speed: Array = attrib_array(Array([500], "rpm"), category="angle per time")
...
class TablePumpDescription:
    ...
    flow_rates: Array = attrib_array(Array([0.0, 0.05, 0.1, 0.15, 0.2, 0.3] * 6, 'm3/s'))

    pressure_boosts: Array = attrib_array(Array(
            [0.0] * 12
            +[
    ...
    heads: Array = attrib_array(Array(
        [0.0] * 12
        + [
            12.0, 10.0, 9.0, 7.5, 5.0, 0.0, 10.0, 9.0, 8.0, 6.0, 3.5, 0.0,
            14.0, 12.0, 10.0, 8.0, 5.5, 0.0, 13.5, 11.2, 9.5, 7.6, 5.2, 0.0,
    ...
    efficiencies: Array = attrib_array(Array(
    ...
    powers: Array = attrib_array(Array(
...
class PumpEquipmentDescription:
    ...
    # fmt: on
    # [[[end]]] (sum: MzC/LIkTUk) (sum: MzC/LIkTUk) (sum: dxZn8buTyh)
...
class CompressorPressureTableDescription:
    ...
    speed_entries: Array = attrib_array(Array([0], "rpm"), category="angle per time")
    corrected_mass_flow_rate_entries: Array = attrib_array(Array([0], "kg/s"))
    pressure_ratio_table: Array = attrib_array(Array([1.0], "-"))
    isentropic_efficiency_table: Array = attrib_array(Array([1.0], "-"))
...
class CvTableDescription:
    ...
    opening: Array = attrib_array(default=Array([], "-"))
    flow_coefficient: Array = attrib_array(default=Array([], "(galUS/min)/(psi^0.5)"))
...
class PigEquipmentDescription:
    ...
    launch_times: Array = attrib_array(default=Array([0.0], "s"))
    ...
    # fmt: on
    # [[[end]]] (sum: jyMN6kwl5z) (sum: jyMN6kwl5z) (sum: BdZkmlPetC)
    ...
    # fmt: on
    # [[[end]]] (sum: W+n+agBmMf) (sum: W+n+agBmMf) (sum: QJ/kXRt3yB)
    ...
    # fmt: on
    # [[[end]]] (sum: LUZ/5RcPa2) (sum: LUZ/5RcPa2) (sum: wYu6+BdFjc)
    ...
    # fmt: on
    # [[[end]]] (sum: jGqpTcorqS) (sum: jGqpTcorqS) (sum: 7VUYd0GERZ)
    ...
    # fmt: on
    # [[[end]]] (sum: wN7wzqbhWp) (sum: wN7wzqbhWp) (sum: bS98jFAj/B)
...
class LeakEquipmentDescription:
    ...
    # fmt: on
    # [[[end]]] (sum: AOfhRguJ6N) (sum: AOfhRguJ6N) (sum: 2rH2wVwV7l)
...
class LinearIPRDescription(CommonIPR):
    ...
    # fmt: on
    # [[[end]]] (sum: +bJ7zOU82k) (sum: +bJ7zOU82k) (sum: r3U12R+7CY)
...
class VogelIPRDescription(CommonIPR):
    ...
    # fmt: on
    # [[[end]]] (sum: 09Us5imZlH) (sum: 09Us5imZlH) (sum: BsUYnwfXz2)
...
class HeatSourceEquipmentDescription:
    ...
    # fmt: on
    # [[[end]]] (sum: HC8YUfkVYj) (sum: HC8YUfkVYj) (sum: 0l1Sjk5IZu)
