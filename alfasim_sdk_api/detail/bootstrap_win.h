...
struct alfasim_sdk_bootstrap {
    alfasim_sdk_bootstrap()
    {
        ...
        get_plugin_input_data_multiplereference_selected_size = (get_plugin_input_data_multiplereference_selected_size_func)GetProcAddress(this->dllHandle, "get_plugin_input_data_multiplereference_selected_size");
