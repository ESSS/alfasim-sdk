...
latex_documents = [
    (master_doc, "alfasim_sdk.tex", "ALFAsim-SDK Documentation", "ESSS", "manual")
]
...
man_pages = [(master_doc, "alfasim_sdk", "ALFAsim-SDK Documentation", [author], 1)]
